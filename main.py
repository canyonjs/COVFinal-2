...
def generate_graph(data_to_graph, chosen_metric):
    ...
    try:
        ...
        print(
            "Graph generated successfully. Check folder output_graphs for file."
        )
    except:
        print(
            "Sorry, something went wrong, please relaunch the program and try again."
        )
        quit()
...
def main():
    ...
    if not query_result:
        print(
            "Sorry, I don't have data for your requested timeframe and metric."
        )
