...
def get_country(country_verify):
    ...
    while True:
        input_country = format_country(
            input("Country/ISO CODE (ex: Honduras/HND, United States/USA): ").
            strip().lower())
...
def get_timeframe():
    ...
    while True:
        ...
        if input_timeframe == "week":
            ...
            print(
                "Alltime graph is currently disabled, choose another option.")
            continue
...
def get_metric(metric_verify):
    ...
    while True:
        input_metric = input(
            "Metric (type 'list' to see options): ").strip().lower()
        ...
        try:
            ...
            if input_metric == "list":
                ...
                print(
                    "You can view descriptions and sources for each of these metrics here:"
                )
                print(
                ...
                print(
                    "Invalid metric, please try again or type 'list' to see all options."
                )
                continue
        except:
            print(
                "Your chosen metric does not appear in the dataset, please try again. Alternatively, type 'list' to see a list of available metrics."
            )
